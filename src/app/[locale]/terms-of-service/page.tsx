...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Call of Duty Black Ops II Wiki",
    description: "Read the Terms of Service for Call of Duty Black Ops II Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Call of Duty Black Ops II Wiki",
      description: "Terms and conditions for using Call of Duty Black Ops II Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Call of Duty Black Ops II Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Call of Duty Black Ops II Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Call of Duty Black Ops II Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Call of Duty Black Ops II Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the game "Call of Duty Black Ops II". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Campaign walkthroughs and mission guides</li>
              <li>Zombies maps, perks, and Easter egg guides</li>
              <li>Multiplayer Pick 10 classes and scorestreaks</li>
              <li>Weapons database and loadout guides</li>
              <li>DLC, Season Pass, and map information</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Call of Duty Black Ops II Wiki is NOT affiliated with, endorsed by, or associated with
              Activision or the official developers of Call of Duty Black Ops II. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Call of Duty Black Ops II Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Activision and/or the developers of Call of Duty Black Ops II. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, CALL OF DUTY BLACK OPS II WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Call of Duty Black Ops II Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@callofdutyblackopsiiwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@callofdutyblackopsiiwiki.wiki</a>
            </p>
            <p>
